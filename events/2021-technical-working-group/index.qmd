...
description: "Two-day event in Cambridge featuring the launch of OpenAlex and iiindex.org, alongside presentations on patent text analysis, firm technology portfolios, startup matching, IP theft responses, historical entrepreneurship data, and patent-paper pairs standardization."
author:
  - Samuel Klein
  - Adam Jaffe
date: "2021-12-03"
image: images/2021_twg.png
categories: [workshop, technical-working-group, featured]
featured: false
---

**December 3-4, 2021**   |   Cambridge, MA (NBER)   |   [Agenda](https://www.nber.org/conferences/innovation-information-initiative-technical-working-group-meeting-fall-2021)
...
## **The Rise of Process Claims: Evidence from a Century of U.S. Patents** ([slides](https://conference.nber.org/conf_papers/f160994/f160994.slides.pdf))
...
A: (Bruno + Bernhard looked at each other and both rolled their eyes, indicating this is a hard problem! <laughter>) Bruno: This is not something we are picking up, and these are important elements. Even if you think about Josh Greer's work in pharma... molecules, and how they are picked up... if it's not expressed in words, we will miss it for now. That's a challenge, more in some areas than in others.
A: Bernhard: Looking at our coverage, how well we do for claims in chem and biology, we're missing a lot. I've just recently come across [a dataset of a few hundred thousand manually classified claims](https://onlinelibrary.wiley.com/doi/abs/10.1002/smj.3351) in chemicals. If you are in the audience, please call me --- I would love to use the dataset just to see how well we do w/ a large sample of chemicals, to improve on the approach.
...
### **Introducing [OpenAlex](http://openalex.org/about)** - maintaining an open replacement for MAG ([outline](https://docs.google.com/document/d/1pN-3Ou2nl6e0g4Oxbv-gpAQWC-a5CWZh73ViPqjkxxk/edit))
...
### **Prototyping an Innovation Data Portal** ([slides](https://docs.google.com/presentation/d/1BQhsE0KVgZDJGOvc0bvvuiYDJtIQIrCA9dRqo-b6P2A/edit#slide=id.p))

**Introducing [iiindex.org](https://iiindex.org/)**
...
## **Intellectual Property Theft** ([slides](https://conference.nber.org/conf_papers/f161001/f161001.slides.pdf))
...
How does theft affect their H1B hires, including specifically from China?
...
Comment: Can H1B be considered immigrants as this is a kind of non-immigrant visa?
Comment: In the sense that people are moving to the US (for their jobs), they are immigrants, even if it's not clear how long they will stay.

---

## **U.S. Entrepreneurship over the Long-run: New Data and Approaches to Measurement** ([slides](https://conference.nber.org/conf_papers/f161002/f161002.slides.pdf))
...
A: We'd love to, but can't too much. One option could be to try to look at what the 'filings' say but they are mostly not digitized and are handwritten (in cursive!) when digitized for the earlier years in our sample...
...
Comment: Can you look at both cosine similarity, not just topic pairs?
